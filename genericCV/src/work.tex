...
\begin{rSection} {Work and Research Experience}
  \begin{rSubsection}{Boston University}{Sep, 2011 - Present}{Research Assistant}{Boston, MA}
    %% \textbf{Boston University} \hfill {\em Sep, 2011 - May, 2013}\\
  ...
  \ignore{\item Developed equalized interconnect for manycore systems; ASIC taped-out using UMC 130nm technology}
  ...
  \begin{rSubsection}{Analog Devices, Inc.}{Feb, 2014 - Feb, 2015}{Mixed-Signal Verification Engineer}{San Jose, CA}
    %% % \begin {itemize}
    %% \textbf{Analog Devices, Inc.} \hfill {\em Feb, 2014 - Feb, 2015} \\
    %% \textit{Mixed-Signal Verification Engineer}
    %% \begin{itemize}
  ...
  \begin{rSubsection}{Analog Devices, Inc.}{May, 2013 - Dec,2013}{Mixed-Signal Design Engineering Intern}{San Jose, CA}
    %% \textbf{Analog Devices, Inc.} \hfill {\em May, 2013 - Dec, 2013} \\
    %% \textit{Mixed-Signal Design Engineering Intern}
    %% \begin{itemize}
